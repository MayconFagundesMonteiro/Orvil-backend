...
INSERT INTO "new_Registros" ("ativo", "dataDevolucao", "dataEmprestimo", "id", "leitorId", "livroId") SELECT "ativo", "dataDevolucao", "dataEmprestimo", "id", "leitorId", "livroId" FROM "Registros";
